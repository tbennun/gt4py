...
class MapToFor(DaceOptimizer):
    ...
    def transform_optimize(self, sdfg):
        from dace.transformation.dataflow import MapCollapse, MapExpansion, MapToForLoop
...
def build_dace_adhoc(
    ...
    **params,
    ...
    from gt4py.backend.dace.base_backend import CPUDaceOptimizer, CudaDaceOptimizer
